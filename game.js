...
const TITLES = [
  ...
  // Stats spécifiques
  {
    ...
    rarity: "uncommon",
    color: "#E0623C",
    condition: { type: "stat", stat: "force", value: 25 },
    desc: "Force ≥ 25.",
  },
  {
    id: "force50",
    ...
    rarity: "rare",
    color: "#E0623C",
    condition: { type: "stat", stat: "force", value: 50 },
    desc: "Force ≥ 50.",
  },
  {
    id: "force100",
  ...
  },
  {
    ...
    rarity: "uncommon",
    color: "#8B82E8",
    condition: { type: "stat", stat: "intelligence", value: 25 },
    desc: "Intelligence ≥ 25.",
  },
  {
    id: "intel50",
    label: "Sage",
    rarity: "rare",
    color: "#8B82E8",
    condition: { type: "stat", stat: "intelligence", value: 50 },
  ...
  },
  {
    ...
    rarity: "uncommon",
    color: "#2EC4A0",
    condition: { type: "stat", stat: "agilite", value: 25 },
    desc: "Agilité ≥ 25.",
  },
  {
    id: "agilite50",
    ...
    rarity: "rare",
    color: "#2EC4A0",
    condition: { type: "stat", stat: "agilite", value: 50 },
    desc: "Agilité ≥ 50.",
  },
  {
    id: "endur25",
    ...
    rarity: "uncommon",
    color: "#D4891A",
    condition: { type: "stat", stat: "endurance", value: 25 },
    desc: "Endurance ≥ 25.",
  },
  {
    id: "endur50",
    ...
    rarity: "rare",
    color: "#D4891A",
    condition: { type: "stat", stat: "endurance", value: 50 },
    desc: "Endurance ≥ 50.",
  },
  {
    id: "charm25",
    ...
    rarity: "uncommon",
    color: "#D94C7A",
    condition: { type: "stat", stat: "charisme", value: 25 },
    desc: "Charisme ≥ 25.",
  },
  {
    id: "charm50",
    ...
    rarity: "rare",
    color: "#D94C7A",
    condition: { type: "stat", stat: "charisme", value: 50 },
    desc: "Charisme ≥ 50.",
  },
  {
    id: "percep25",
    ...
    rarity: "uncommon",
    color: "#3E99E8",
    condition: { type: "stat", stat: "perception", value: 25 },
    desc: "Perception ≥ 25.",
  },
  ...
  },
  {
    ...
    rarity: "epic",
    color: "#D94C7A",
    condition: { type: "urgent", value: 20 },
    desc: "Compléter 20 quêtes urgentes.",
  },
  ...
  },
  {
    ...
    rarity: "mythic",
    color: "#FFD700",
    condition: { type: "quests", value: 300 },
    desc: "Compléter 300 quêtes.",
  },
];
...
function checkUnlockedTitles(player) {
  ...
  for (const t of TITLES) {
    ...
    if (c.type === "quests")
      met = (player.total_quests_completed || 0) >= c.value;
    if (c.type === "urgent")
      met = (player.urgent_quests_completed || 0) >= c.value;
    if (c.type === "allstats")
      met = Object.values(player.stats).every((v) => v >= c.value);
...
const URGENT_POOL = [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "t2",
        name: "Tenue de combat",
        type: "check",
        desc: "Tenue soignée et propre",
      },
    ],
  },
  {
